...
function getData(a)
{
    ...
    }).then((data)=>
    {
       ...
       var value=data;       
           ...
           document.getElementById('1img').src = img1;
           ...
           document.getElementById('4img').src = img3;
           var img3=(value['data'][4]['avatar']);
           document.getElementById('5img').src = img3;
           var img3=(value['data'][5]['avatar']);
           document.getElementById('6img').src = img3;
           ///// name
           var first1=(value['data'][0]['first_name']);
           var last1=(value['data'][0]['last_name']);
           document.getElementById('1name').innerHTML =first1+" "+last1;
           var first1=(value['data'][1]['first_name']);
           var last1=(value['data'][1]['last_name']);
           document.getElementById('2name').innerHTML =first1+" "+last1;
           var first1=(value['data'][2]['first_name']);
           var last1=(value['data'][2]['last_name']);
           document.getElementById('3name').innerHTML =first1+" "+last1;
           var first1=(value['data'][3]['first_name']);
           var last1=(value['data'][3]['last_name']);
           document.getElementById('4name').innerHTML =first1+" "+last1;
           var first1=(value['data'][4]['first_name']);
           var last1=(value['data'][4]['last_name']);
           document.getElementById('5name').innerHTML =first1+" "+last1;
           var first1=(value['data'][5]['first_name']);
           var last1=(value['data'][5]['last_name']);
           document.getElementById('6name').innerHTML =first1+" "+last1;
     /////mail
      var mail1=(value['data'][0]['email']);
           document.getElementById('1mail').innerHTML=mail1;
           var mail2=(value['data'][1]['email']);
           document.getElementById('2mail').innerHTML=mail2;
           var mail3=(value['data'][2]['email']);
           document.getElementById('3mail').innerHTML=mail3;
           var mail3=(value['data'][3]['email']);
           document.getElementById('4mail').innerHTML=mail3;
           var mail3=(value['data'][4]['email']);
           document.getElementById('5mail').innerHTML=mail3;
           var mail3=(value['data'][5]['email']);
           document.getElementById('6mail').innerHTML=mail3;
